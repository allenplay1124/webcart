                ...
                <div class="col text-right">
                    <ul class="nav justify-content-end top-bar-right">
                        <li class="nav-item dropdown">
                            ...
                            <a href="#" class="nav-link dropdown-toggle" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" id="dropDownCurrency">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <a heef="#" class="nav-link dropdown-toggle" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" id="dropDownLanguage">
                        ...
                        <li calss="nav-item">
                            ...
                            <a class="nav-link" href="<?= site_url('member/register') ?>">
                                <?= lang('Home.register') ?>
                            </a>
                        </li>
...
<script type="text/javascript">
    $('.btn-lang').click(function(e) {
        $.ajax({
            url: '<?= site_url("api/member/set_lang") ?>',
            type: 'PATCH',
            data: {
                lang: $(this).val()
            },
